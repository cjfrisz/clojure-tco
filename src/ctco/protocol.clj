...
;;
;; PRecurify:
;;      Converts tail position self-recursive function applications into
;;      the recur form to take advantage of Clojure's existing contant
;;      space tail call mechanisms. This is used both to maximize
;;      performance of code generated by the 'ctco' macro and is also
;;      the keystone of the 'recurify' macro for automatically inserting
;;      the recur form appropriately without applying the other CTCO
;;      transformations. 
;;
;; PThunkify:
